		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.clueList, function (index, object) {
					...
					html+= ' 		<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/clue/queryClueRemarkListById.do?id='+object.id+'\';">'+object.fullname+object.appellation+'</a></td>';
